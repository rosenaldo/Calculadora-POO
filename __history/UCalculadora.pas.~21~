...
begin
  EDT_NUM03.Text := Calculadora.Dividir.Operacao(EDT_NUM01.Text,
    EDT_NUM02.Text);
end;

procedure TFOR_PRINCIPAL.BTN_MULTIPLICARClick(Sender: TObject);
begin
  EDT_NUM03.Text := Calculadora.Multiplicar.Operacao(EDT_NUM01.Text,
    EDT_NUM02.Text);
end;

procedure TFOR_PRINCIPAL.BTN_SOMAClick(Sender: TObject);
begin
  EDT_NUM03.Text := Calculadora.Soma.Operacao(EDT_NUM01.Text,
    EDT_NUM02.Text);
end;

procedure TFOR_PRINCIPAL.BTN_SUBTRAIRClick(Sender: TObject);
begin
  EDT_NUM03.Text := Calculadora.Subtrair.Operacao(EDT_NUM01.Text,
    EDT_NUM02.Text);
end;
